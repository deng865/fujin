...
export default function MapHomeContent() {
  ...
  // Note: gesture handling is now fully owned by MapListSheet itself.
  // The map area no longer intercepts touches — this prevents the "touch
  // fighting" that caused sticky/laggy drawer interactions.
