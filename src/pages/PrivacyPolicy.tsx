...
const content = {
  zh: {
    ...
    intro: `Fujin（"本应用"、"我们"）是一个面向北美华人社区的本地生活信息平台，由 Shuwen LLC 运营。我们高度重视您的隐私。本隐私政策详细说明我们在您使用本应用（包括 iOS、Android 及 Web 版本）时如何收集、使用、共享和保护您的个人信息。`,
    sections: [
      {
        heading: `一、我们收集的信息`,
  ...
  en: {
    ...
    intro: `Fujin (the "App", "we", "us") is a hyper-local life-services platform for the North American Chinese-speaking community, operated by Shuwen LLC. This Privacy Policy explains in detail how we collect, use, share, and protect your personal information when you use the App on iOS, Android, or the web.`,
    sections: [
      {
