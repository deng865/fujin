...
const content = {
  zh: {
    ...
    intro: `欢迎使用 Fujin（以下简称"本应用"）。本应用由 Shuwen LLC 运营，是面向北美华人社区的本地生活信息平台。在使用本应用前，请您仔细阅读并同意本《服务条款》。一旦您注册、登录或使用本应用，即视为您已阅读、理解并同意接受本条款及《隐私政策》的全部内容。`,
    sections: [
      {
        heading: `一、服务描述`,
  ...
  en: {
    ...
    intro: `Welcome to Fujin (the "App"), operated by Shuwen LLC, a hyper-local life-services platform for the North American Chinese-speaking community. By registering, signing in, or using the App you confirm that you have read, understood, and agreed to these Terms of Service and the Privacy Policy.`,
    sections: [
      {
